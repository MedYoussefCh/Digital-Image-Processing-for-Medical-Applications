...
IMG_PATH = 'C:\\Users\\YOUSSEF\\Desktop\\projet_enjeux\\Brain_tumor\\Brain_tumor_dataset/'
...
img = cv2.imread('C:\\Users\\YOUSSEF\\Desktop\\projet_enjeux\\Brain_tumor\\brain_tumor_dataset\\yes\\Y108.jpg')
...
'''
# load base model
vgg16_weight_path = 'C:\\Users\\YOUSSEF\\Desktop\\projet_enjeux\\Brain_tumor\\Pretrained_models\\vgg16_weights_tf_dim_ordering_tf_kernels_notop.h5'
...
history = model.fit_generator(train_generator,steps_per_epoch=50,epochs=EPOCHS,validation_data=validation_generator,validation_steps=25,callbacks=[es])
